...
#ChallengeSpec: {
	...
	// dnsName is the identifier that this challenge is for, e.g. example.com. If
	// the requested DNSName is a 'wildcard', this field MUST be set to the
	// non-wildcard domain, e.g. for `*.example.com`, it must be `example.com`.
	dnsName!: string

	// References a properly configured ACME-type Issuer which should be used to
	// create this Challenge. If the Issuer does not exist, processing will be
	...
	// format: `<private key JWK thumbprint>.<key from acme server for challenge>`.
	// For DNS01 challenges, this is the base64 encoded SHA256 sum of the `<private
	// key JWK thumbprint>.<key from acme server for challenge>` text that must be
	// set as the TXT record content.
	key!: string
	...
	// The URL of the ACME Challenge resource for this challenge. This can be used
	// to lookup details about the status of this challenge.
	url!: string

	// wildcard will be true if this challenge is for a wildcard identifier, for
	// example '*.example.com'.
	wildcard?: bool
}
