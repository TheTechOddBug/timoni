...
func (in *Runtime) DeepCopyInto(out *Runtime) {
	*out = *in
	if in.Clusters != nil {
		...
		*out = make([]RuntimeCluster, len(*in))
		copy(*out, *in)
	}
	if in.Refs != nil {
		in, out := &in.Refs, &out.Refs
		*out = make([]RuntimeResourceRef, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpdateAttribute) DeepCopyInto(out *UpdateAttribute) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpdateAttribute.
func (in *UpdateAttribute) DeepCopy() *UpdateAttribute {
	if in == nil {
		return nil
	}
