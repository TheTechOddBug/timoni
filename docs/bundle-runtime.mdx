...
sidebarTitle: "Bundle runtime"
description: "Fetch values at apply time from Kubernetes Secrets, ConfigMaps and other resources."
---

While Timoni [Bundles](/bundle) offer a way to specify the config values in declarative manner,
...
For more details please see the [multi-cluster deployments guide](/bundle-multi-cluster).
